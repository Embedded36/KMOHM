...
static volatile u8* const DIO_u8PINS[NUMBER_OF_PORTS] = { DIO_u8PINA, DIO_u8PINB, DIO_u8PINC, DIO_u8PIND };
...
//	*DIO_u8PORTC = ((*DIO_u8PORTC) & (~DIO_u8PORTC_DIR)) | (DIO_u8PORTC_DIR & DIO_u8PORTC_VAL);
	...
	*DIO_u8PORTD = DIO_u8PORTD_VAL;
//	*DIO_u8PORTD = /*DIO_u8PORTD_VAL; */ ((*DIO_u8PORTD) & (~DIO_u8PORTD_DIR)) | (DIO_u8PORTD_DIR & DIO_u8PORTD_VAL);
